...
class MultiPlatformNetworkGeneratorDeprecatedPlugin : Plugin<Project> {
    ...
    override fun apply(target: Project) {
        ...
        target.afterEvaluate { it.setupProject(generatedDir) }
    }

    private fun Project.setupProject(generatedDir: String) {
